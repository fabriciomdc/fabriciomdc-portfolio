...
export const Contact = () => {
  return (
    <>
              ...
              <div className="relative mb-6 inline-block rounded-[20px] border-2 border-foreground bg-foreground px-4 py-3">
                ...
                <div
                  ...
                  style={{
                    ...
                    borderTop: "12px solid var(--foreground)",
                  }}
                />
              </div>
            ...
            <div className="mt-10 flex flex-wrap gap-3">
              {[
                ...
                <a
                  key={item.label}
                  href="#"
                  className="group inline-flex items-center gap-3 border-2 border-foreground bg-card px-4 py-3 text-[9px] uppercase tracking-[0.15em] transition-all hover:bg-foreground/5"
                >
                  <item.icon />
                  {item.label}
                </a>
      ...
      <footer className="border-t-2 border-foreground bg-foreground py-4 text-center">
        <span className="font-mono text-[9px] uppercase tracking-[0.15em] text-background">
          FAB.DEV — Portfolio / Built with intention / 2026
        </span>
      </footer>
    </>
  );
